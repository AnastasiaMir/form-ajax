...
export default () => {
  ...
  // Код для отправки данных Бэк. Некуда отправлять, поэтому функция закомментирована
  ...
  elements.form.addEventListener('submit', (e) => {
    ...
    callBackendAPI()
      ...
      .catch((err) => {
        ...
        watchedState.serverMessage = 'Сервер не запущен! не удалось получить ответ с сервера!';
      });
  });
};
